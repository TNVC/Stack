...
LFLAGS=-lpthread
SRC=main stack stackdumb logging elementfunctions hash systemlike coloroutput consolewaiting
SRCDIR=src
SOURCE=${patsubst %, ${SRCDIR}/%.cpp, ${SRC}}
OBJDIR=objects
OBJECTS=${patsubst %, ${OBJDIR}/%.o, ${SRC}}
INCLUDE=-Iinclude
...
%: ${SRCDIR}/%.cpp
	@${CC} -c ${INCLUDE} ${CFLAGS} ${SRCDIR}/$@.cpp -o ${OBJDIR}/$@.o
